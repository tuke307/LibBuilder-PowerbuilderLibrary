// project=PBDotNet.Core, file=Type.cs, create=09:16 Copyright (c) 2021 tuke productions.
// All rights reserved.
using System;
...
{
    /// <summary>
    /// In type in pb can be a lot of thigs i.g. function, userobject, window, structure
    /// etc. Every type can have "within" types.
    /// </summary>
    public class Type
    {
        #region private
